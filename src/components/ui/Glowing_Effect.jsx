...
export const GLOW_PRESETS = {
  cyan: {
    ...
    headCore: 'radial-gradient(circle, rgba(230, 252, 255, 0.95) 0%, rgba(56, 189, 248, 0.65) 40%, rgba(14, 165, 233, 0.25) 70%, transparent 85%)',
    headSparkle: 'bg-cyan-100/95',
    sparkleShadow: '0 0 16px rgba(186, 230, 253, 0.95), 0 0 30px rgba(56, 189, 248, 0.65)',
    trailGradients: [
      'radial-gradient(circle, rgba(224,247,255,0.92) 0%, rgba(56,189,248,0.7) 35%, rgba(14,165,233,0.35) 55%, transparent 75%)',
